...
description: Use when you want to understand what reviewers actually enforce on a repo, discover undocumented team standards, onboard to a new codebase's culture, or create a coding conventions skill from real review patterns. Trigger on "what do reviewers care about", "extract conventions from PRs", "mine review feedback", "what patterns does this team enforce", "create a conventions guide from PR history", "team standards from code reviews", "PR feedback analysis", or "what does the team prefer". Surfaces implicit coding conventions from merged PR review comments.
---
